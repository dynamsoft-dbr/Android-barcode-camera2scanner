...
public class Camera2BasicFragment extends Fragment
    ...
    private void createCameraPreviewSession() {
        try {
            ...
            mPreviewRequestBuilder.set(CaptureRequest.CONTROL_AF_REGIONS,new MeteringRectangle[]{new MeteringRectangle(new Point((mPreviewSize.getWidth()-500)/2
                    ,(mPreviewSize.getHeight()-500)/2),new Size(500,500),1000)});
            mPreviewRequestBuilder.set(CaptureRequest.CONTROL_AE_REGIONS,new MeteringRectangle[]{new MeteringRectangle(new Point((mPreviewSize.getWidth()-500)/2
                    ,(mPreviewSize.getHeight()-500)/2),new Size(500,500),1000)});
